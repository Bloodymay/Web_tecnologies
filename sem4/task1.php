...
браузеры не умеют выполнять php-код, для этого нужен интерпретатор (специальная программа, которая разбирает и выполняет код), если вы его не устанавливали себе на компьютер, 
то можете воспользоваться сайтом 
...
$work_exp = [
    [
        'post' => 'Junior QA',
        'beginning_date' => '15.05.2004',
        'ending_date' => '12.11.2004',
        'description' => 'test cases, testing',
    ],
    [
        'post' => 'Middle QA',
        'beginning_date' => '12.11.2004',
        'ending_date' => '10.10.2006',
        'description' => 'test cases, testing',
    ],
    [
        'post' => 'Senior QA',
        'beginning_date' => '12.11.2006',
        'ending_date' => 'Current',
        'description' => 'test cases, testing',
    ],
];
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
              ...
              <?php for ($i = 0; $i < count($work_exp); $i++):?>
                <div class="w3-container">
                  <h5 class="w3-opacity"><b><?php echo $work_exp[$i]['post'];?> </b></h5>
                  <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work_exp[$i]['beginning_date'];?> - <span
                    class="w3-tag w3-teal w3-round"><?php echo $work_exp[$i]['ending_date'];?></span></h6>
                  <p><?php echo $work_exp[$i]['description'];?></p>
                </div>  
              <?php endfor;?>
        </div>
